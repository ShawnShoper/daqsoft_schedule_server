...
import com.daqsoft.schedule.server.web.vo.TaskTemplateVO;
import com.daqsoft.schedule.server.web.vo.TaskVO;
...
public class TaskController
{
	...
	public Response editTaskTemplate(@PathVariable String id, String name,
			String url, String cookies, String params, String cronexp,
			HttpServletResponse resp)
	{
		Response response = new Response();
		try
